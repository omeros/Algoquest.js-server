...
const BoundList_1 = require("./BoundList");
class Algoquest {
    constructor() {
        /* Constructor for objects of class Algoquest */
        this.count = 0;
        this.counEreaIsBlock = 0;
        this.counEreaIsClear = 0;
    }
    ...
    findMax(l, r, t, b, arrayOfShaps) {
        ...
        if (this.ereaIsClear(l, r, t, b, arrayOfShaps)) {
            ...
            let newB = new Bound_1.Bound(l, r, t, b); //Bound
            let bn = new BoundNode_1.BoundNode(newB); //BoundNode
            let b1 = new BoundList_1.BoundList(bn); // BoundList
            return b1;
        }
