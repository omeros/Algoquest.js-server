...
class Algoquest {
  ...
  //  unit the bounds in 4 difference lists of Bounds to one list of bound ,return  BoundList(BoundList,BoundList,BoundList,BoundList ) 
    ...
    // Assuming this is part of the Algoquest class
// and that BoundList is properly defined elsewhere
    ...
    //     b4: BoundList | null
    //   ): BoundList | null {
    //     // Handle the case where all four lists are non-null
    //     if (b1 && b2 && b3 && b4) {
    //       const b11 = b1.copyList();
    //       const b12 = b2.copyList();
    //       const b13 = b3.copyList();
    ...
    //       let f4 = b1.combine(b2);
    //       let f5 = b2.combine(b1);
    ...
    //       let f6 = b3.combine(b4);
    //       let f7 = b4.combine(b3);
      
    //       if (!f6 || !f7) return null;
    ...
    //       f5 = f5.unit(f7);
    //       if (!f5 || !b11 || !b13) return null;
      
    //       let f8 = b11.combine(b13);
    //       let f9 = b13.combine(f8);
      
    //       if (!f8 || !f9) return null;
    ...
    //       f9 = f9.unit(f8);
    //       if (!f9 || !b12 || !b14) return null;
      
    //       let f10 = b12.combine(b14);
    //       let f11 = b14.combine(f10);
      
    //       if (!f10 || !f11) return null;
    ...
    //     // Handle cases where exactly three lists are non-null
    //     if (b1 && b2 && b3 && !b4) {
    //       let f1 = b1.combine(b2);
    //       if (!f1) return null;
      
    //       let f2 = b2.combine(f1);
    //       if (!f2) return null;
    ...
    //       let f3 = f2.combine(b3);
    //       if (!f3) return null;
      
    //       let f4 = b3.combine(f3);
    //       if (!f4) return null;
    ...
    //     if (b1 && !b2 && b3 && b4) {
    //       let f1 = b1.combine(b3);
    //       if (!f1) return null;
      
    //       let f2 = b3.combine(f1);
    //       if (!f2) return null;
    ...
    //       let f3 = f2.combine(b4);
    //       if (!f3) return null;
      
    //       let f4 = b4.combine(f3);
    //       if (!f4) return null;
    ...
    //       let f1Unit = f1.unit(f2);
    //       if (!f1Unit) return null;
      
    //       f1 = f1Unit;
    //       if (!f1) return null;
      
    //       let f3 = f1.combine(b4);
    //       if (!f3) return null;
      
    //       let f4 = b4.combine(f1);
    //       if (!f4) return null;
    ...
    //     // Handle cases where exactly two lists are non-null
    //     if (!b1 && !b2 && b3 && b4) {
    //       let f1 = b3.combine(b4);
    //       if (!f1) return null;
      
    //       let f2 = b4.combine(f1);
    //       if (!f2) return null;
    ...
    //     // Handle cases where exactly one list is non-null
    //     if (b1 && !b2 && !b3 && !b4) {
    //       return b1;
    //     }
    //     if (!b1 && b2 && !b3 && !b4) {
    ...
    //     // If all lists are null, return null
    //     return null;
    //   }
      

    /// with if check statments
    // unitTheGroup(
    //     b1: BoundList | null,
    //     b2: BoundList | null,
    //     b3: BoundList | null,
    ...
    //     let f1: BoundList | null = null;
    //     let f2: BoundList | null = null;
    //     let f3: BoundList | null = null;
    //     let f4: BoundList | null = null;
    //     let f5: BoundList | null = null;
    //     let f6: BoundList | null = null;
    //     let f7: BoundList | null = null;
    //     let f8: BoundList | null = null;
    //     let f9: BoundList | null = null;
    //     let f10: BoundList | null = null;
    //     let f11: BoundList | null = null;
    ...
    //     // Handle cases where only three lists are non-null
    //     if (b1 && b2 && b3 && !b4) {
    //       f1 = b1.combine(b2);
    //       if (f1) {
    //         f2 = b2.combine(f1);
    ...
    //     // Handle cases where only two lists are non-null
    //     if (!b1 && !b2 && b3 && b4) {
    //       f1 = b3.combine(b4);
    //       if (f1) {
    //         f2 = b4.combine(f1);
    ...
    //     // Handle cases where only one list is non-null
    //     if (b1 && !b2 && !b3 && !b4) {
    //       return b1;
    //     }
    //     if (!b1 && b2 && !b3 && !b4) {
